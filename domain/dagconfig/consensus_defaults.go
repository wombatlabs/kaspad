...
const (
	...
	defaultSubsidyGenesisReward                    = 600000000 * constants.SompiPerKaspa
	defaultPreDeflationaryPhaseBaseSubsidy         = 9 * constants.SompiPerKaspa
	defaultDeflationaryPhaseBaseSubsidy            = 8 * constants.SompiPerKaspa
